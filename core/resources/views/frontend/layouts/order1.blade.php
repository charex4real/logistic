                                                ...
                                                <div class="box-content">
                                                    ...
                                                    <div class="form-row">
                                                        <div class="form-group col">
                                                            ...
                                                            <input type="text" id="sender_name" name="sender_name"  class="form-control form-control-lg"  placeholder="Sender Name..." />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-row">
                                                        <div class="form-group col">
                                                            <label class="font-weight-bold text-dark text-2">Sender Email</label>
                                                    ...
                                                    <div class="form-row">
                                                        <div class="form-group col">
                                                            ...
                                                            <textarea rows="5"  id="sender_address"  name="sender_address"   class="form-control form-control-lg"   >
                                                ...
                                                <div class="box-content">
                                                        <div class="form-row">
                                                            <div class="form-group col">
                                                                ...
                                                                <input type="text" id="area_code" name="area_code"class="form-control form-control-lg" >
                                                            </div>
                                                        </div>
                                                         ...
                                                         <div class="form-row">
                                                            <div class="form-group col">
                                                                ...
                                                                <input type="text" id="receiver_name" name="receiver_name"class="form-control form-control-lg" >
                                                            </div>
                                                        </div>
                                                         <div class="form-row">
                                                            <div class="form-group col">
                                                                <label class="font-weight-bold text-dark text-2">Recipient Phone</label>
                                                                <input type="text" id="receiver_phone" name="receiver_phone"class="form-control form-control-lg" >
                                                            </div>
                                                        </div>

                                                         <div class="form-row">
                                                            <div class="form-group col">
                                                                <label class="font-weight-bold text-dark text-2">Recipient Email</label>
                                                         ...
                                                         <div class="form-row">
                                                            <div class="form-group col">
                                                                <label class="font-weight-bold text-dark text-2">Recipient Address</label>
                                                                 <textarea rows="5" type="text" id="receiver_address"  name="receiver_address"   class="form-control form-control-lg"   >
                                                            </textarea>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-3">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control form-control-lg currier_type SK" name="currier_type[]" id="courier_type_0" onchange="currier_type(0)">
                                                    ...
                                                    <div class="col-lg-3">
                                                        ...
                                                        <div class="input-group input-group-lg">
                                                            <input class="form-control form-control-lg currier_quantity_0 currier_quantity SK" max="300" type="number" name="currier_quantity[]" disabled onchange="currier_quantity(0)" onkeyup="currier_quantity(0)"  placeholder="Quantity">
