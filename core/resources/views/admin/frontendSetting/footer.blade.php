        ...
        <div class="card-body">
            <form action="{{ route('frontend.footer') }}" method="post">
                ...
                <div class="col-md-6">
                 ...
                 <div class="col-md-12">
                    <div class="form-group">
                        <label for="footer_about" style="text-transform: uppercase;"><strong>Footer About</strong></label>
                        <textarea class="form-control"  name="footer_about">
                            {{ $setting->footer_about ?? old('footer_about') }}
                     </textarea>
                        <input type="hidden" value="{{ $setting->id }}" name="id">
                    </div>
                </div>
